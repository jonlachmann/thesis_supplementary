...
basename <- paste0("run",dirname, "_mjmcmc_100Kg")
run_count <- 20
iter <- 32768

data_use <- cbind(mill_y_g100K, mill_x_g)[1:n_obs,]
...
run_mjmcmc(linear.g.prior.loglik, data_use, sim_probs, sim_pars, 1, iter, run_count, basename)
